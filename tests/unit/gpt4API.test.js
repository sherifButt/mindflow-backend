...
describe('GPT-4 API Tests', () => {
   ...
   describe('createInstruction', () => {
      it('should create a new instruction', async () => {
         ...
         expect(createdInstruction.description).toBe(
            mockInstruction.description
         )
         expect(createdInstruction.parameters).toEqual(
            mockInstruction.parameters
         )
      })
   })
   ...
   describe('deleteInstruction', () => {
      it('should delete an existing instruction', async () => {
         ...
         expect(deletedInstruction.description).toBe(
            mockInstruction.description
         )
         expect(deletedInstruction.parameters).toEqual(
            mockInstruction.parameters
         )
      })
   })
